...
for n = 1:nSv
    ...
    codeCenterTime = cst + COH_INT_TIME/2;
    ...
    weight(:,n) = magnitude.^2/COH_INT_TIME;
    
    % Exclude data with to low SNR.
    ind = SNR(magnitude)<POSITION_DB_LIMIT;
